...
CMS_NEWSLETTER_MESSAGE_URL_VIEW_REGEXP = f'^(/)({CMS_NEWSLETTER_VIEW_PREFIX_PATH})/(?P<slug>[a-zA-Z0-9\-\_]*)/{CMS_NEWSLETTER_MESSAGE_SUB_PATH}/(?P<code>[0-9]*)(/)?$'
