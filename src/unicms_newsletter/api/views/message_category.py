...
class MessagePublicationCategoryList(UniCMSListCreateAPIView):
    """
    """
    description = ""
    ...
    def get_queryset(self):
        ...
        if newsletter_id and message_id:
            return MessagePublicationCategory.objects.filter(message__newsletter__pk=newsletter_id,
                                                  message__pk=message_id)
        return MessagePublicationCategory.objects.none()  # pragma: no cover
...
class MessagePublicationCategoryView(UniCMSCachedRetrieveUpdateDestroyAPIView):
    """
    """
    description = ""
    ...
    def get_queryset(self):
        ...
        message_cats = MessagePublicationCategory.objects.filter(message__newsletter__pk=newsletter_id,
                                                                 message__pk=message_id,
                                                                 pk=cat_id)
        return message_cats
...
class MessagePublicationCategoryFormView(APIView):

    def get(self, *args, **kwargs):
        form = MessagePublicationCategoryForm(message_id=kwargs.get('message_id'))
